...
def receive_video(command):
    global frame_to_display, client_socket

    if command == "Stop":
        # implement stop logic here, Stop manage_mcamera.py and/or stop displaying on webpage
        pass

    if command == "Start":
        command = "start_server_view"
...
# Need endpoint for recieving a command from web view user
...
if __name__ == "__main__":
    receive_thread = threading.Thread(target=receive_video, args=("Start",))
